...
export async function POST(request: NextRequest) {
  console.log('=== BULK PRICING API CALLED ===');
  console.log('Request URL:', request.url);
  console.log('Request method:', request.method);
  console.log('Request headers:', Object.fromEntries(request.headers.entries()));
  
  try {
    console.log('Bulk Pricing API: Starting request processing');
    ...
    if (userError || !user) {
      console.log('Bulk Pricing API: Authentication failed:', userError);
    ...
    console.log('Bulk Pricing API: User authenticated:', user.id);
